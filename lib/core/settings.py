...
TRANSLATE="Pings汉化版"
SITE = "https://www.hackersafe.cn"
DEFAULT_USER_AGENT = "%s (%s)" % (VERSION_STRING, SITE)
DEV_EMAIL_ADDRESS = "dev@sqlmap.org"
ISSUES_PAGE = "https://github.com/BugFor-Pings/CN_Sqlmap/issues/new"
GIT_REPOSITORY = "https://github.com/BugFor-Pings/CN_Sqlmap.git"
GIT_PAGE = "https://github.com/BugFor-Pings/CN_Sqlmap"
WIKI_PAGE = "https://github.com/sqlmapproject/sqlmap/wiki/"
ZIPBALL_PAGE = "https://github.com/BugFor-Pings/CN_Sqlmap/zipball/master"
...
BANNER = """\033[01;33m\
        ___
       __H__
 ___ ___[.]_____ ___ ___  \033[01;37m{\033[01;%dm%s %s\033[01;37m}\033[01;33m
|_ -| . [.]     | .'| . |
|___|_  [.]_|_|_|__,|  _|
      |_|V...       |_|   \033[0m\033[4;37m%s\033[0m\n
""" % (TYPE_COLORS.get(TYPE, 31),TRANSLATE, VERSION_STRING.split('/')[-1], SITE)
...
LEGAL_DISCLAIMER = "\033[31m严禁使用本程序进行未经授权的违规渗透测试，遵守网络安全法，共同维护网络安全。\033[0m"
